...
import heroLogic.HeroPower;
import org.junit.Test;

//import static heroLogic.HeroPower.FIREBLAST;
...
public class MinionTest {
    ...
    public void testHealth() {
        Minion m = new Minion("20", 2, "MinionCard", "myMinion.img", "hunter",5, 3, new DivineShield(true, "DivineShield"));
    ...
    public void testAttackHero() {
        Minion m = new Minion("e2", 2, "derp", "img", "mage",  5, 2, null);
    ...
    public void testLoseHealth(){
        Minion m = new Minion("20", 2, "MinionCard", "myMinion.img", "hunter", 10, 3, null);
